...
const columns: ColumnDef<Product>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => h('div', { class: 'capitalize' }, row.original.brands?.brand_name ?? ''),
    },
    {
        ...
        cell: ({ row }) => h('div', { class: 'capitalize' }, row.original.categories?.cat_name ?? ''),
    },
    {
        accessorKey: 'pr_name',
        header: ({ column }) => {
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return h(
                'div',
                prices.map(p =>
                    h('div', { class: 'text-sm' }, ` ${formatPrice(p.price)}`)
                )
            )
        }
    },
...
<template>
    ...
    <div class="w-full p-5">
        ...
        <Input
            ...
            :model-value="table.getColumn('pr_name')?.getFilterValue() as string"
            @update:model-value=" table.getColumn('pr_name')?.setFilterValue($event)"
        />
        <DropdownMenu>
            <DropdownMenuTrigger as-child>
