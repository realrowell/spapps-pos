...
const columns: ColumnDef<Location>[] = [
    ...
    },
    {
        ...
        header: 'Code',
        cell: ({ row }) => h('div', { class: 'capitalize' },  row.getValue('loc_code')),
    },
    {
        ...
        cell: ({ row }) => h('div', { class: 'capitalize' }, row.getValue('loc_name')),
    },
    {
...
<template>
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                <DropdownMenuLabel>Actions</DropdownMenuLabel>
                    <DropdownMenuItem @click="copy(category.loc_code)">
                        Copy category ID
                    </DropdownMenuItem>
                <DropdownMenuSeparator />
    ...
    <div class="w-full p-5">
        ...
        <Input
            ...
            :model-value="table.getColumn('loc_name')?.getFilterValue() as string"
            @update:model-value=" table.getColumn('loc_name')?.setFilterValue($event)"
        />
        <DropdownMenu>
            <DropdownMenuTrigger as-child>
