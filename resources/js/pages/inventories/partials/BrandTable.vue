...
const columns: ColumnDef<Brand>[] = [
    ...
    },
    {
        ...
        header: 'Code',
        cell: ({ row }) => h('div', { class: 'capitalize' },  row.getValue('brand_code')),
    },
    {
        ...
        cell: ({ row }) => h('div', { class: 'capitalize' }, row.getValue('brand_name')),
    },
    {
...
<template>
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                <DropdownMenuLabel>Actions</DropdownMenuLabel>
                    <DropdownMenuItem @click="copy(category.brand_code)">
                        Copy category ID
                    </DropdownMenuItem>
                <DropdownMenuSeparator />
    ...
    <div class="w-full p-5">
        ...
        <Input
            ...
            :model-value="table.getColumn('brand_name')?.getFilterValue() as string"
            @update:model-value=" table.getColumn('brand_name')?.setFilterValue($event)"
        />
        <DropdownMenu>
            <DropdownMenuTrigger as-child>
