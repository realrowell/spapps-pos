...
const columns: ColumnDef<PaymentProvider>[] = [
    ...
    },
    {
        ...
        header: 'Code',
        cell: ({ row }) => h('div', { class: 'capitalize' },  row.getValue('provider_code')),
    },
    {
        ...
        cell: ({ row }) => h('div', { class: 'capitalize' }, row.getValue('provider_name')),
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return h(
                Badge,
                {
                    variant: isActive ? "subtleSuccess" : "subtleDanger"
                },
    ...
    },
    {
        ...
        enableHiding: false,
        cell: ({ row }) => {
            const payment_provider = row.original
...
<template>
    <DefineTemplate v-slot="{ payment_provider }">
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                <DropdownMenuLabel>Actions</DropdownMenuLabel>
                    <DropdownMenuItem @click="copy(payment_provider.provider_code)">
                        Copy mop ID
                    </DropdownMenuItem>
                <DropdownMenuSeparator />
                <DropdownMenuItem>View customer</DropdownMenuItem>
                <DropdownMenuItem>View mop details</DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
    </DefineTemplate>
    <div class="w-full p-5">
        ...
        <Input
            ...
            :model-value="table.getColumn('provider_name')?.getFilterValue() as string"
            @update:model-value=" table.getColumn('provider_name')?.setFilterValue($event)"
        />
        <DropdownMenu>
            <DropdownMenuTrigger as-child>
