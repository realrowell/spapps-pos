...
const columns: ColumnDef<ModeOfPayment>[] = [
    ...
    {
        accessorKey: 'mop_code',
        header: 'Code',
        cell: ({ row }) => h('div', { class: 'capitalize' },  row.getValue('mop_code')),
    },
    {
        accessorKey: 'mop_name',
        header: ({ column }) => {
            return h(Button, {
                variant: 'ghost',
        ...
        cell: ({ row }) => h('div', { class: 'capitalize' }, row.getValue('mop_name')),
    },
    {
...
<template>
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                <DropdownMenuLabel>Actions</DropdownMenuLabel>
                    <DropdownMenuItem @click="copy(mop.mop_code)">
                        Copy mop ID
                    </DropdownMenuItem>
                <DropdownMenuSeparator />
    ...
    <div class="w-full p-5">
        ...
        <Input
            ...
            :model-value="table.getColumn('mop_name')?.getFilterValue() as string"
            @update:model-value=" table.getColumn('mop_name')?.setFilterValue($event)"
        />
        <DropdownMenu>
            <DropdownMenuTrigger as-child>
